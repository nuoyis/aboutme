...
class yuDB {
     ...
     public function __construct($yudb_host, $yudb_user, $yudb_password, $yudb_name, $yu_database = "mysql", $yudb_chaeset = 'utf8'){
         $this->yudb_host = $yudb_host;
         $this->yudb_user = $yudb_user;
         $this->yudb_password = $yudb_password;
         $this->yudb_name = $yudb_name;
         $this->yudb_charset = $yudb_chaeset;
         $this->result = '';
         $this->databease = $yu_database;
     }
